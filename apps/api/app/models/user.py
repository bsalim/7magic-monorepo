...
class UserRole(Base):
    ...
    # branch_id is part of the key so the same role can be granted on several
    # branches -- one row per (user, role, branch).
    __table_args__ = (
    ...
    # NULL is an org-wide grant; a branch scopes the role to it.
